...
function scrollToSection(sectionId) {
  ...
  console.log('Current page:', window.location.pathname); // Check if we're on the homepage

  var isHomePage = window.location.pathname.endsWith('index.html') || window.location.pathname.endsWith('/') || window.location.pathname === '' || window.location.pathname.includes('index.html');
  console.log('Is homepage:', isHomePage);

  if (!isHomePage) {
    // If not on homepage, navigate to homepage first
    console.log('Not on homepage, redirecting to index.html#' + sectionId);
    window.location.href = "index.html#".concat(sectionId);
    return;
  }
  ...
  if (target) {
    console.log('Scrolling to section:', sectionId, target); // For dynamic sections, wait a bit longer for content to load

    var delay = sectionId === 'new-arrivals' || sectionId === 'top-selling' ? 300 : 100;
    setTimeout(function () {
      var finalTarget = document.getElementById(sectionId);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.getElementById('footer')) loadFooter(); // Handle hash navigation on page load
  ...
  (function initHeroSlider() {
    var images = ['shopco-web-master/src/assets/images/heroimg.png', 'shopco-web-master/src/assets/images/ko co phong.png', 'shopco-web-master/src/assets/images/capdoi2.png'];
